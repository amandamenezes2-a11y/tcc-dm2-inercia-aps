...
st.header("📊 Principais Resultados da Coorte")
...
st.info("""
A elevada prevalência observada evidencia importante lacuna assistencial no
acompanhamento longitudinal de indivíduos com DM2 na Atenção Primária à Saúde.
""")
